...
# CAP_NET_RAW required for ARP/ICMP conflict detection
# CAP_NET_BIND_SERVICE required for binding to port 67
# Set via: docker run --cap-add=NET_RAW --cap-add=NET_BIND_SERVICE
# Or in docker-compose: cap_add: [NET_RAW, NET_BIND_SERVICE]
